...
# If you are intended to use other network like jenkins for example then use following line and replace --network minikube in docker run commands
...
# to create image of jenkins-blueocean, please refer custom.jenkins.dockerfile
...
docker build -f ./docker-files/jenkins.pipeline.tools.dockerfile -t jenkins-blueocean .
